  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      >
        ...
        <circle cx="70" cy="70" r="65" fill="none" stroke="url(#logoBlueGradient)" strokeWidth="3" />
        ...
        >
          ...
          {[0, 45, 90, 135, 180, 225, 270, 315].map((angle, i) => (
            <circle key={i} cx="70" cy="25" r="3" fill="url(#logoBlueGradient)" transform={`rotate(${angle} 70 70)`} />
          ))}
        </g>
