...
export default function FloatingButtons() {
  ...
  return (
    <>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-24 right-6 w-12 h-12 bg-primary/80 rounded-full flex items-center justify-center shadow-lg hover:bg-primary transition-all z-40 ${
